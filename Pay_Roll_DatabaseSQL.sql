...
('Rupa', 90000.00, '2005-12-01'),
('Pooja', 50000.00, '2008-03-02'),
('Rohit', 60000.00, '2007-04-07'),
('Pushpa', 90000.00, '2016-01-03'),
('Yoga', 80000.00, '2018-06-10');

--UC-4-Retrieve-Employee-Payroll-Data--
select * from employee_payroll;

--UC-5-Retrieve-Salary-Of-Particular-Employee-And-Particular-Date-Range--
select salary from employee_payroll where Name = 'Rupa';
...
update employee_payroll set Gender = 'M' where Id in (3,5);
...
alter table employee_payroll add Department varchar(200) not null default 'ECE';
...
insert into employee_payroll (Name, Basic_pay, StartDate, Gender, Phone, Address, Department, Deductions, Taxable_Pay, Income_Tax,Net_pay)
					  values ('Uday', 60000.00, '2011-05-05', 'M', 7999837990, 'Bangalore', 'SD',1000.00, 59000.00, 2000.00,0);
update employee_payroll set Net_Pay = (Basic_Pay-Deductions-Taxable_Pay-Income_Tax);
select * from employee_payroll;
